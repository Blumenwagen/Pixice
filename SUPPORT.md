...
Pixice 0.1.0-beta.2 is a prerelease. Report reproducible problems at https://github.com/Blumenwagen/Pixice/issues.
...
- macOS on Intel;
- Windows on x64;
- Linux on x64 through AppImage and Debian packages.

Arm Windows and Arm Linux packages are not part of the first release.
