...
export const APPLICATION_READ_OPERATIONS = new Set([...READ_OPERATIONS, 'connect.status', 'github.status', 'workflowCredentials.list', 'extensions.list', 'ios.environment', 'ios.discover', 'ios.state', 'tray.state', 'tray.refresh', 'tray.thread', 'service.status', 'native.poll']);
