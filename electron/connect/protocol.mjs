...
export const CAPABILITIES = {
  ...
  widgets: { list: 'widgets:list', draft: 'widgets:draft', cancelDraft: 'widgets:cancel-draft', commit: 'widgets:commit', update: 'widgets:update', updateUserState: 'widgets:update-user-state', readSource: 'widgets:read-source', delete: 'widgets:delete' },
...
export const REMOTE_EVENTS = new Set(['BrowserState', 'BrowserOpenRequested', 'PreviewWorkspacePresentRequested', 'ActivityReceived', 'RuntimeEvent', 'RuntimeStatus', 'RuntimeError', 'TaskUpdated', 'AgentUpdated', 'AttentionRequired', 'AttentionResolved', 'AttentionReset', 'BoardUpdated', 'WidgetUpdated', 'FocusUpdated', 'FocusPolicyUpdated', 'ProjectDeleted', 'ProactivityUpdated', 'TaskReceiptUpdated', 'UsageUpdated', 'CodexLimitsUpdated', 'InstrumentUpdated', 'InstrumentOpenRequested', 'InstrumentInteractionUpdated', 'TaskPreviewOpenRequested', 'FilePreviewOpenRequested', 'WorkflowUpdated', 'WorkflowRunUpdated', 'WorkflowOpenRequested', 'WorkflowTriggersUpdated', 'TranscriptionState', 'TranscriptionModelProgress']);
