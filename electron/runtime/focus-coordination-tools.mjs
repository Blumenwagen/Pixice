...
export const focusCoordinationTools = [
  ...
  tool("list_work", "List durable project outcomes, recent decisions, and the fixed full-access worker runtime rule. Resolve follow-ups semantically using this list and read_work before dispatching duplicate work.", { query: string(240) }),
